            ...
            <main className="lg:flex max-w-screen-2xl mx-auto">
                ...
                <div className="flex-grow m-5 shadow-sm">
                    ...
                    <div className="flex flex-col p-5 space-y-10 bg-white">
                        ...
                        {
                            items.map((item, i) => (
                                <CheckoutProduct id={item.id} key={i} title={item.title} rating={item.rating} price={item.price} description={item.description} category={item.category} image={item.image} hasPrime={item.hasPrime} />
                            ))
                        }
                    </div>
                </div>
